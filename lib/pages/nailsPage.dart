          ...
          Container(
            child:Flexible(
              child:Padding(
                ...
                child: StreamBuilder(
                  stream: FirebaseFirestore.instance.collection("SousCategories").where("idCategorie", isEqualTo: FirebaseFirestore.instance.doc('Categories/4UFwQChDvPHUrg7k8XiS')).snapshots(),
